    ...
    <div class="contact">
      <div class="contact-wrapper">
        ...
        <div class="form">
          ...
          <form method="post" action="{{ route('adminTopicConfirm') }}" novalidate enctype="multipart/form-data">
            @csrf
            <p>
            ...
            <label class="form-item">メイン画像<span>*</span></label>
            ...
            <label class="form-item">その他画像1<span>*</span></label>
            ...
            <label class="form-item">その他画像2<span>*</span></label>
